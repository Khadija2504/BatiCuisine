...
public class Labor extends Composant {
    ...
    public Labor(int id, String nom, TypeComposant typeComposant, double tauxTva, int projetId, double tauxHoraire, double heuresTravail, double productiviteOuvrier) {
